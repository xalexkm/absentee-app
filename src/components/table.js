          ...
          <div className="table-row">
            <div className={"table-cell"}>
              <div
                ...
                className="flex justify-center items-center underline underline-offset-1 cursor-pointer"
              >
                Name {sortedColumn === "name" && <IoArrowDownOutline />}
              </div>
            </div>
            <div className={"table-cell"}>
              <div
                onClick={() => handleSort("absenceType")}
                className="flex gap-2 justify-center items-center underline underline-offset-1 cursor-pointer"
              >
                Absence Type{" "}
                {sortedColumn === "absenceType" && <IoArrowDownOutline />}
              </div>
            </div>
            <div className={"table-cell text-xs max-w-32"}>
            ...
            <div className={"table-cell"}>
              ...
              >
                Start Date{" "}
                {sortedColumn === "startDate" && <IoArrowDownOutline />}
              </div>
            </div>
            <div className={"table-cell"}>
              <div
                ...
                className="flex gap-2 justify-center items-center underline underline-offset-1 cursor-pointer"
              >
                End Date {sortedColumn === "endDate" && <IoArrowDownOutline />}
              </div>
            </div>
          </div>
        </div>
          ...
          {view.map((row, index) => (
            <div className="table-row" key={index}>
              <div
                ...
                onClick={() => handleNameClick(row.employee.id)}
              >
                <div className="flex gap-2 items-center">
                  <span className="underline underline-offset-1 cursor-pointer">
                    {row.employee.firstName} {row.employee.lastName}
                  </span>{" "}
                  <AbsenceConflictLabel
                    employeeId={row.employee.id}
                  ></AbsenceConflictLabel>
                </div>
              </div>
              <div className="table-cell">
                {row.absenceType ? absenceTypeMap[row.absenceType] : "N/A"}
              </div>
              <div className="table-cell">
